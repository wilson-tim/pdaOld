...
<%@ page import="com.vsb.surveyBean, com.vsb.recMonPropertiesBean" %>
...
<body onUnload="">
  <form onSubmit="return singleclick();" action="doorstepSurveyScript.jsp" method="post">
    <%-- Table for page title --%>
    <table width="100%">
      <tr>
        <td bgcolor="#259225" align="center">
          <h2><font color="white"><b>Doorstep Survey</b></font></h2>
        </td>
      </tr>
    ...
    <table width="100%">
      <tr>
        <td align="center">
          <b><%= ((String)pageContext.getAttribute("site_name_1")).trim() %></b>
        </td>
      </tr>
    </table>
    ...
    <jsp:include page="include/back_contComp_button.jsp" flush="true" />
        
    <%@ include file="include/insp_sched_buttons.jsp" %>
    <jsp:include page="include/footer.jsp" flush="true" />
    <input type="hidden" name="input" value="doorstepSurvey" /> 
