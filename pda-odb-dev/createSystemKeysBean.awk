# usage:
# awk -f createSystemKeysBean.awk #FILENAME#
#
# #FILENAME# is the filename to check for key names in. Format of the file is
# #TYPE# #KEY-NAME#
# Eg.
# String customer
#
# Eg.
# awk -f createSystemKeysBean.awk keysList.txt
#
...
# Get the name and type of the key
{
  if(!($2 in props)){
    props[$2]=$1
  }
...
print ""
print "public class systemKeysBean {"
for(item in props) {
