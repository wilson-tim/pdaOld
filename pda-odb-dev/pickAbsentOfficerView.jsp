...
<body onUnload="">
  <form onSubmit="return singleclick();" action="pickAbsentOfficerScript.jsp" method="post">
    <table width="100%">
      <tr>
      ...
      <tr><td><font color="#ff6565"><b><jsp:getProperty name="pickAbsentOfficerBean" property="error" /></b></font></td></tr>
      <tr><td><hr size="2" noshade="noshade" /></td></tr>
    </table>
    <table width="100%">
        ...
        <sql:resultSet id="rset">
          <tr>
            <td valign="top" width="10">
              ...
              <if:IfTrue cond='<%= ((String)pageContext.getAttribute("user_name")).trim().equals(pickAbsentOfficerBean.getUser_name()) %>' >
                <input type="radio" name="user_name"  value="<sql:getColumn position="1" />"  checked="checked" />
              </if:IfTrue>
              <if:IfTrue cond='<%= !((String)pageContext.getAttribute("user_name")).trim().equals(pickAbsentOfficerBean.getUser_name()) %>' >
                <input type="radio" name="user_name"  value="<sql:getColumn position="1" />" />
              </if:IfTrue>
            </td>
            <td valign="top">
    ...
    <jsp:include page="include/back_cover_buttons.jsp" flush="true" />
    <jsp:include page="include/footer.jsp" flush="true" />
    <input type="hidden" name="input" value="pickAbsentOfficer" />
