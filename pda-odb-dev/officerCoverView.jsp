...
<body onUnload="">
  <form onSubmit="return singleclick();" action="officerCoverScript.jsp" method="post">
    <table width="100%">
      <tr>
        <td bgcolor="#259225" align="center">
          <h2><font color="white"><b>Assign Cover</b></font></h2>
        </td>
      </tr>
      <tr><td><hr size="2" noshade="noshade" /></td></tr>
      <tr><td><font color="#ff6565"><b><jsp:getProperty name="officerCoverBean" property="error" /></b></font></td></tr>
      <tr><td><hr size="2" noshade="noshade" /></td></tr>
    </table>
    <% String color="#ffffff"; %>
    <table cellpadding="2" cellspacing="0" width="100%">
      <tr>
        <td colspan="3">
          <b>Assigning cover for:</b> <jsp:getProperty name="pickAbsentOfficerBean" property="user_name" />
        </td>
      </tr>
        ...
        <sql:resultSet id="rset">
          ...
          <tr bgcolor="<%= color %>" >
            <td valign="top" width="10">
              <sql:getColumn position="1" to="cover_name" />
              <if:IfTrue cond='<%= ((String)pageContext.getAttribute("cover_name")).trim().equals(officerCoverBean.getCover_name()) %>' >
                <input type="radio" name="cover_name" id="<sql:getColumn position="1" />" value="<sql:getColumn position="1" />"  checked="checked" />
              </if:IfTrue>
              <if:IfTrue cond='<%= !(((String)pageContext.getAttribute("cover_name")).trim().equals(officerCoverBean.getCover_name())) %>' >
                <input type="radio" name="cover_name" id="<sql:getColumn position="1" />" value="<sql:getColumn position="1" />" />
              </if:IfTrue>
            </td>
            <td valign="top">
    ...
    <input type="hidden" name="input" value="officerCover" />
