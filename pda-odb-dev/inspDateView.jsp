...
<%@ page import="com.vsb.inspDateBean, com.vsb.helperBean, com.vsb.recordBean" %>
...
<body onUnload="">
  <form onSubmit="return singleclick();" action="inspDateScript.jsp" method="post">
    <table width="100%">
      <tr>
        <td bgcolor="#259225" align="center">
          <h2><font color="white"><b>Inspection Date</b></font></h2>
        </td>
      </tr>
      <tr><td><hr size="2" noshade="noshade" /></td></tr>
      <tr><td><font color="#ff6565"><b><jsp:getProperty name="inspDateBean" property="error" /></b></font></td></tr>
      <tr><td><hr size="2" noshade="noshade" /></td></tr>
    </table>
    <table width="100%">
      <tr>
    ...
    <input type="hidden" name="input" value="inspDate" />
