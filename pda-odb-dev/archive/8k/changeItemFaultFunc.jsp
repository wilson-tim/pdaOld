...
<sess:equalsAttribute name="form" match="changeItemFaultFunc" value="false">
  changeItemFaultFunc - Permission Denied
</sess:equalsAttribute>
<sess:equalsAttribute name="form" match="changeItemFaultFunc">
  ...
  <sql:statement id="stmt" conn="con1">
    ...
    <if:IfTrue cond='<%= changedItem == true || changedFault == true %>' >
