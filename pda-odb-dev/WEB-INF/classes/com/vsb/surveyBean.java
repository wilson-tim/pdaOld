 ...
 *   YESNO   - 'Y'/'N' answer
 *   TEXT    - string answer
 *   NUMBER  - string with expected numeric representation. (Unchecked!)
  ...
  */
  ...
  public void addAnswer( String id, String[] answer ){
    ...
    else if( getQuestion_type( id ).equals("NUMBER") )
    {
      String tempAnswer = answer[0];
      if( tempAnswer == null || tempAnswer.equals("") ){
        // 06/07/2010  TW  Force user to enter a number
        // answer[0] = "0";
        answer[0] = "";
      }
    }
  ...
  */
  ...
  public boolean isValid( String id ){
    ...
    if( getQuestion_valid( id ).equals("Y") ){
      ...
      /**
       * Same as the TEXT, NUMBER needs to have a value that is
       * greater than or equal to 0 to be valid.
       */
      else if( getQuestion_type(id).equals("NUMBER"))
      {
        String[] answers = getAnswer( id );
      ...
      /**
       * There needs to be at least one checkbox ticked for the block
