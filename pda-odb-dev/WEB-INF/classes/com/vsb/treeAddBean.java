...
public class treeAddBean extends formBean {
  ...
  public void setFrequency(String frequency) {
    this.frequency = DbUtils.cleanString(frequency);
  }
  ...
  public void setNext_due(String next_due) {
    this.next_due = DbUtils.cleanString(next_due);
  }
  ...
  public void setGpsLat(String gpsLat) {
    this.gpsLat = DbUtils.cleanString(gpsLat);
  }
  ...
  public String getView_next_due() {
    return view_next_due;
  }

  public void setView_next_due(String view_next_due) {
    this.view_next_due = DbUtils.cleanString(view_next_due);
  }
  ...
  public void setGpsLng(String gpsLng) {
    this.gpsLng = DbUtils.cleanString(gpsLng);
  }
  ...
  public void setOsmapref(String osmapref) {
    this.osmapref = DbUtils.cleanString(osmapref);
  }
