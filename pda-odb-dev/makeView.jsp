...
<body onUnload="">
  <form onSubmit="return singleclick();" action="makeScript.jsp" method="post">
    <table width="100%">
      <tr>
      ...
      <tr><td><font color="#ff6565"><b><jsp:getProperty name="makeBean" property="error" /></b></font></td></tr>
      <tr><td><hr size="2" noshade="noshade" /></td></tr>
    </table>
    <table width="100%">
      <tr>
          ...
          <select name="make_ref">
            ...
            <sql:statement id="stmt" conn="con">
              ...
              <sql:resultSet id="rset">
                <sql:getColumn position="1" to="make_ref" />
                <sql:getColumn position="2" to="make_desc" />
                <if:IfTrue cond='<%= pageContext.getAttribute("make_desc") != null && !(((String) pageContext.getAttribute("make_desc")).trim().equals("")) %>' >
                  <if:IfTrue cond='<%= pageContext.getAttribute("make_ref").equals(makeBean.getMake_ref()) %>' >
    ...
    <input type="hidden" name="input" value="make" /> 
