        ...
        if (insertDefaults.equals("Y") || insertInspections.equals("Y") || insertSamples.equals("Y") ) {
          ...
          try {
            ...
            while (comp_rs != null && comp_rs.next()) {
              ...
              String comp__service_c = valueOrBlank(comp_rs.getString("service_c"));
                ...
                if (ignoreComplaint == false) {
                  ...
                  if (ignoreComplaint == false) {
                    ...
                    if (comp__action_flag.equals("D")) {
                      ...
                      pstmt.setString(17, valueOrNull(comp__service_c));
                      pstmt.setString(18, valueOrNull(comp__contract_ref));
                      pstmt.setString(19, valueOrNull(comp__feature_ref));
                      pstmt.setString(20, valueOrNull(comp__location_c));
                      pstmt.setString(21, valueOrNull(comp__pa_area));
                      pstmt.addBatch();      
