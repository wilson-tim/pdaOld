...
import com.dmn.MonListDaemon;

public class InitMonListDaemonServlet extends HttpServlet {
  private String error = "";
  private DataSource ds = null;
  private MonListDaemon dmn = new MonListDaemon();
  ...
  public void init() throws ServletException {
    ...
    // set the daemon's wakeup time
    // Get the JNDI value of the daemon wakeup time to use
    String wakeupTime = getInitParameter("wakeupTime");
    dmn.setWakeupTime(wakeupTime);
  ...
  public void doGet(HttpServletRequest request,
    ...
    out.println("<b>Initialization servlet for mon_list daemon.</b><br/>");
    if (! error.equals("")) {
