...
import com.dmn.ConSumListDaemon;

public class InitConSumListDaemonServlet extends HttpServlet {
  private String error = "";
  private DataSource ds = null;
  private ConSumListDaemon dmn = new ConSumListDaemon();
  ...
  public void doGet(HttpServletRequest request,
    ...
    out.println("<b>Initialization servlet for con_sum_list daemon.</b><br/>");
    if (! error.equals("")) {
