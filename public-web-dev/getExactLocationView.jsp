...
<form action="publicaccess.jsp" method="post">
    ...
    <div class="UserInput">
        <table>
            <tr>
            <td>
                <label class="input-name">Exact Location</label>
            </td>
            </tr>
            <tr>
            <td>
                <input class="input-field" id="exact_location" name="exact_location" type="text" maxlength="70" size="40" value="<%= incidentBean.getExact_location() %>"/>
            </td>
            </tr>
        </table>
    </div>
