...
function SiteRecruit_PageConfigurationBroker()
{
    ...
    this.m = [        
    ['//[\\w\\.-]+/en-au/', jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_PageConfiguration_p15808382-en-au' + jsBuildNumber + '.js', 0, null],
    ['//[\\w\\.-]+/en-ca/', jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_PageConfiguration_p15808382-en-ca' + jsBuildNumber + '.js', 0, null],
    ['//[\\w\\.-]+/en-gb/', jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_PageConfiguration_p15808382mt-en-gb' + jsBuildNumber + '.js', 1, null],
    ['//[\\w\\.-]+/en-us', jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_PageConfiguration_p15808382mt-3332mt' + jsBuildNumber + '.js', 0, null],
    ['//[\\w\\.-]+/en-us/practices(/|$)', jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_PageConfiguration_P-2692mt-3332mt-p15808382mt' + jsBuildNumber + '.js', 1, null],
    ['//[\\w\\.-]+/en-us/teamsystem(/|$)', jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_PageConfiguration_p11017322-p15808382-3332mt' + jsBuildNumber + '.js', 1, null],
    ['//[\\w\\.-]+/fr-ca/', jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_PageConfiguration_p15808382mt-fr-ca' + jsBuildNumber + '.js', 0, null],
    ['//[\\w\\.-]+/fr-fr/', jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_PageConfiguration_France-p12038685-p15466742' + jsBuildNumber + '.js', 0, null],
    ['//[\\w\\.-]+/hi-in/', jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_PageConfiguration_p15808382-hi-in' + jsBuildNumber + '.js', 0, null],
    ['//[\\w\\.-]+/zh-cn/', jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_PageConfiguration_p15808382mt-zh' + jsBuildNumber + '.js', 0, null],
    ];
