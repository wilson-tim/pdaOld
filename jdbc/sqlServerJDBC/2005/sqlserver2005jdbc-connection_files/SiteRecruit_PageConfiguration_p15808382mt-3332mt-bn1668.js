...
SiteRecruit_Config.frequency = 0.0027;
...
// Iterate through the survey configurations.
        ...
        SiteRecruit_Config.invitations[0].weight = 8981;
        ...
        SiteRecruit_Config.invitations[0].invitationContent = '<table width="360" cellpadding="3" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr><td> <table width="100%" cellpadding="1" cellspacing="0" border="0" bgcolor="#999999"><tr><td> <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr valign="top"><td> <img src="/Platform/Controls/SurveyLauncher/resources/msdn-logo-stripe.gif" /><a href="Close" onclick="@declineHandler"><img border="0" src="/Platform/Controls/SurveyLauncher/resources/msdn-close.gif" /></a><br /> <img src="/Platform/Controls/SurveyLauncher/resources/top-stripe.gif" /> <table width="100%" cellpadding="5"><tr><td>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 0 0 15px 0;">Microsoft is conducting an online survey to understand use of MSDN Online.  We’d like to see which pages you visit today and then have you complete a survey when you leave MSDN Online.<br /><br />Would you like to participate? </div>  <div align="center" style="margin: 0; padding: 0"> <input style="margin: 0; padding: 0" type="button" value="  Yes  " onclick="@acceptHandler" />&nbsp;&nbsp; <input style="margin: 0; padding: 0"  type="button" value=" No " onclick="@declineHandler" /> </div>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 15px 0 2px 0;"><a style="color:#0000EE; text-decoration: underline; " href="http://www.microsoft.com/info/privacy.mspx" target="_blank">Privacy Statement</a></div>  </td></tr></table> <img src="/Platform/Controls/SurveyLauncher/resources/bottom-stripe.gif" /></td></tr></table> </td></tr></table> </td></tr></table>   '; 
        ...
        SiteRecruit_Config.invitations[0].autoCentering = true;
                    ...
                    SiteRecruit_Config.invitations[0].trackerUrl = '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_Tracker_p15808382mt.htm';
        ...
        SiteRecruit_Config.invitations[1].weight = 1019;
        ...
        SiteRecruit_Config.invitations[1].invitationContent = '<table width="360" cellpadding="3" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr><td> <table width="100%" cellpadding="1" cellspacing="0" border="0" bgcolor="#999999"><tr><td> <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF"><tr valign="top"><td> <img src="/Platform/Controls/SurveyLauncher/resources/msdn-logo-stripe.gif" /><a href="Close" onclick="@declineHandler"><img border="0" src="/Platform/Controls/SurveyLauncher/resources/msdn-close.gif" /></a><br /> <img src="/Platform/Controls/SurveyLauncher/resources/top-stripe.gif" /> <table width="100%" cellpadding="5"><tr><td>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 0 0 15px 0;">Microsoft is conducting an online survey to understand use of the Microsoft.com Web site. We\'d like to see which pages you visit today and then have you complete a survey when you leave the Microsoft.com Web site. Would you like to participate? </div>  <div align="center" style="margin: 0; padding: 0"> <input style="margin: 0; padding: 0" type="button" value="  Yes  " onclick="@acceptHandler" />&nbsp;&nbsp; <input style="margin: 0; padding: 0"  type="button" value=" No " onclick="@declineHandler" /> </div>  <div style="font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 11px; color: #000000; margin: 15px 0 2px 0;"><a href="http://privacy.microsoft.com/en-us/default.aspx" target="_blank">Privacy Statement</a></div>  </td></tr></table> <img src="/Platform/Controls/SurveyLauncher/resources/bottom-stripe.gif" /></td></tr></table> </td></tr></table> </td></tr></table>   '; 
        ...
        SiteRecruit_Config.invitations[1].autoCentering = true;
                    ...
                    SiteRecruit_Config.invitations[1].trackerUrl = '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_Tracker_3332mt.htm';
...
if (SiteRecruit_Globals.isInternetExplorer || SiteRecruit_Globals.isMozilla)
{
    ...
    {  
        SiteRecruit_Globals.startBuilder = true;
                    ...
                    var uniqueUrl = jsDomain + '/Platform/Controls/SurveyLauncher/resources/SiteRecruit_InvitationBuilder'+ jsBuildNumber + '.js?' + (new Date()).getTime();
