...
public class jobreq {
  ...
  public String apostrophe (String fieldString) {
    // replace each '(apostrophe) with two e.g. ''
    String nextChar = "";
    String outputString = "";
  ...
  public int controller2(String userName,
                         ...
                         String assetId,
                         String jobType,
                         String problemDetails1,
                         String problemDetails2,
                         String problemDetails3,
                         String problemDetails4,
                         String userEmail,
                         int numTries,
    ...
    do {
      ...
      try  {
        ...
        queryString = "insert into cw_job " +
          "(cw_job_id, reported_by, date_reported, time_reported, " +
          "status_flag, logged_by, log_date, log_time, " +
          "site_code, building_code, locat_code, access_code, " +
          "account_code, allowce_time_hrs, asset_cost_cent, asset_id, " +
          "asset_name, asset_no, asset_type, category, " +
          "charg_cost_cent, comp_time_plan, contract_code, contract_type, " +
          "dckt_iss_yn, delay_time_comp, delay_time_comp_a, delay_time_resp, " +
          "delay_time_resp_a, docket_no, dorc_flag, down_serv_level, " +
          "downtime_hours, estimated_cost, estimated_hrs, failure_yn, " +
          "fault_code, frequency, grade_1, grade_2, " +
          "grade_3, grade_4, job_id_req_no, job_type_code, " +
          "labour_cost, maintenance_plan, management_unit, materials_cost, " +
          "out_of_seq_flag, phoenix_code, priority_code, project_code, " +
          "purch_order_flag, quantity_1, quantity_2, quantity_3, " +
          "quantity_4, reason_for_delay, resp_serv_level, resp_time_plan, " +
          "rev_allow_time, rev_wk_cont_time, safety_permit_yn, series, " +
          "statutory_job, sub_asset_no, time_resp, time_resp_a, " +
          "time_to_repr_hrs, tot_hours_compl, trade, usr_ref_fld, " +
          "week_planned, wk_cont_time_hrs, work_type, workshop, " +
          "wrk_done_summary, tradesman, email, contact, " +
          "notify) values " +
          "('" + nextCwJobId + "', '" + userName + "', " + date + ", " + time + ", " +
          "'1', 'faultlog', " + date + ", " + time + ", " +
          "'', '', '', '', " +
          "'', 0.00, '', '" + assetId + "', " +
          "'', '', '', '', " +
          "'', 00:00, '', '', " +
        ...
        //Insert the fault job reported details into cw_dets
        queryString = "insert into cw_dets " +
          "(cw_dets_job_id, detail_1, detail_2, detail_3, detail_4, detail_5, detail_6, detail_7) " +
          "values ('" + nextCwJobId + "', '" + problemDetails1 + "', '" + problemDetails2 + "', '" + problemDetails3 + "', '" + problemDetails4 + "', '', '', '');";
        stmt = con.createStatement();
        stmt.executeUpdate(queryString);
        stmt.close();
        
        //Insert the fault job reported details into cw_rep_dets
        queryString = "insert into cw_rep_dets " +
          "(cw_job_id, detail_1, detail_2, detail_3, detail_4) " +
          "values ('" + nextCwJobId + "', '" + problemDetails1 + "', '" + problemDetails2 + "', '" + problemDetails3 + "', '" + problemDetails4 + "');";
        stmt = con.createStatement();
        stmt.executeUpdate(queryString);
        stmt.close();
        ...
        //Unlock the cw_rep_dets table
        queryString = ("unlock cw_rep_dets;");
        stmt = con.createStatement();
        stmt.executeUpdate(queryString);
        stmt.close();
