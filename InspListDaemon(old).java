  ...
  public void run() {
    ...
    while (true) {
      ...
      if (action.equals("run")) {
        ...
        // Only insert defaults if allowed to. 
        ...
        // Only insert inspections if allowed to. 
        if (insertInspections.equals("Y")) {
          status = status + "<br/>Inserting inspections ...<br/>";
          try {
            // defaults
            sqlCmd = "insert into insp_list (" +
              "    complaint_no," +
            ...
            while (pda_user_rs.next()) {
              ...
              while (comp_rs.next()) {
                ...
                if (ignoreComplaint == false) {
                  ...
                  site_rs = stmt.executeQuery(sqlCmd); 
                  site_rs.next();
                  String site__site_name_1 = valueOrBlank(site_rs.getString("site_name_1"));
                  String site__ward_code = valueOrBlank(site_rs.getString("ward_code"));

                  // Add the record to a preparedStatement Batch
                  pstmt.setInt(1, Integer.parseInt(comp__complaint_no));
                  pstmt.setString(2, valueOrNull(comp__action_flag));
                  pstmt.setString(3, valueOrNull(comp__item_ref));
                  pstmt.setString(4, valueOrNull(comp__site_ref));
                  pstmt.setString(5, valueOrNull(comp__postcode));
                  pstmt.setString(6, valueOrNull(site__site_name_1));
                  pstmt.setString(7, valueOrNull(site__ward_code));
                  pstmt.setDate(8, comp__date_entered);
                  pstmt.setString(9, valueOrNull(comp__ent_time_h));
                  pstmt.setString(10, valueOrNull(comp__ent_time_m));
                  pstmt.setString(11, valueOrNull(comp__ent_time_h));
                  pstmt.setString(12, valueOrNull(comp__ent_time_m));
                  pstmt.setString(13, valueOrNull(comp__recvd_by));
                  pstmt.setString(14, valueOrNull(comp__comp_code));
                  pstmt.setString(15, valueOrNull(pda_user__user_name));
                  pstmt.setString(16, valueOrNull(comp__contract_ref));
                  pstmt.setString(17, valueOrNull(comp__feature_ref));
                  pstmt.setString(18, valueOrNull(comp__location_c));
                  pstmt.setString(19, valueOrNull(comp__pa_area));
                  pstmt.addBatch();      
        ...
        // Only insert samples if allowed to. 
        if (insertSamples.equals("Y")) {
          status = status + "<br/>Inserting samples ...<br/>";
          try {
            // defaults
            sqlCmd = "insert into insp_list (" +
              "    complaint_no," +
            ...
            while (pda_user_rs.next()) {
              ...
              while (comp_rs.next()) {
                ...
                // For samples no users limit list is used

                // Ignore the complaint if some of the details are missing.
                // None yet.

                // Process all complaints, no sample are ignored
                ...
                pstmt.setString(7, valueOrNull(site__ward_code));
                pstmt.setDate(8, comp__date_entered);
                pstmt.setString(9, valueOrNull(comp__recvd_by));
                pstmt.setString(10, valueOrNull(comp__comp_code));
                pstmt.setString(11, valueOrNull(pda_user__user_name));
                pstmt.setString(12, valueOrNull(comp__contract_ref));
                pstmt.setString(13, valueOrNull(comp__feature_ref));
                pstmt.setString(14, valueOrNull(comp__location_c));
                pstmt.setString(15, valueOrNull(comp__pa_area));
                pstmt.addBatch();      
