...
public class PageSet {
  ...
  //
  public void setPageSet (ResultSet rs, String db_date_fmt) throws SQLException {
    clear();
    records.setRowSet(rs, db_date_fmt);
    calculatePage();
  }
  ...
  //
  public void addToPageSet (ResultSet rs, String db_date_fmt) throws SQLException {
    records.addToRowSet(rs, db_date_fmt);
    calculatePage();
  }
