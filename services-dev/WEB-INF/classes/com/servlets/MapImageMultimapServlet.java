...
public class MapImageMultimapServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    String surl = context.getInitParameter("multimap_url") +
      context.getInitParameter("multimap_key") + 
      "?lat=" + lat +
      "&lon=" + lng + 
      "&zoomFactor=" + request.getParameter("Z") + 
